      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
        ...
        <div className="bg-gradient-to-br from-teal-50 to-cyan-100 p-4 md:p-6 rounded-lg md:rounded-xl shadow-sm border border-teal-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 md:w-14 md:h-14 bg-teal-200 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
              <TrendingUp className="h-6 w-6 md:h-7 md:w-7 text-teal-700" />
            </div>
          </div>
        </div>
