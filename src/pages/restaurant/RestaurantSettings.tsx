              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                <div className="space-y-3">
                  {Object.entries(formData.settings.business_hours).map(([day, hours]) => (
                    <div key={day} className="bg-white rounded-lg p-4 shadow-sm border border-gray-200 hover:border-blue-300 transition-all">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                      />
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Configura cómo deseas recibir notificaciones de nuevos pedidos
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border border-yellow-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Recibirás notificaciones de nuevos pedidos</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Formato internacional (ej: +1234567890)</p>
                  </div>
                </div>
              </div>

              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <h4 className="text-md font-semibold text-gray-900 mb-4">Preferencias de Notificación</h4>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <input
                      ...
                      className="h-5 w-5 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500 mt-0.5"
                      id="sound-enabled"
                    />
                    <div className="flex-1">
                      <label htmlFor="sound-enabled" className="text-sm font-medium text-gray-900 cursor-pointer flex items-center gap-2">
                        <Bell className="w-4 h-4" />
                        Habilitar sonidos de notificación
                      </label>
                      <p className="text-xs text-gray-600 mt-1">
                        Reproduce un sonido cuando llegue un nuevo pedido
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <input
                      type="checkbox"
                      checked={formData.settings.notifications.email_enabled !== false}
                      onChange={(e) => updateFormData('settings.notifications.email_enabled', e.target.checked)}
                      className="h-5 w-5 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500 mt-0.5"
                      id="email-enabled"
                    />
                    <div className="flex-1">
                      <label htmlFor="email-enabled" className="text-sm font-medium text-gray-900 cursor-pointer flex items-center gap-2">
                        <Mail className="w-4 h-4" />
                        Notificaciones por Email
                      </label>
                      <p className="text-xs text-gray-600 mt-1">
                        Recibe un correo cuando llegue un nuevo pedido
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <input
                      type="checkbox"
                      checked={formData.settings.notifications.browser_enabled !== false}
                      onChange={(e) => updateFormData('settings.notifications.browser_enabled', e.target.checked)}
                      className="h-5 w-5 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500 mt-0.5"
                      id="browser-enabled"
                    />
                    <div className="flex-1">
                      <label htmlFor="browser-enabled" className="text-sm font-medium text-gray-900 cursor-pointer flex items-center gap-2">
                        <Globe className="w-4 h-4" />
                        Notificaciones del Navegador
                      </label>
                      <p className="text-xs text-gray-600 mt-1">
                        Muestra notificaciones en tu navegador (requiere permiso)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm text-yellow-800 font-medium">Sobre las notificaciones:</p>
                    <ul className="text-xs text-yellow-700 mt-2 space-y-1 list-disc list-inside">
                      <li>Las notificaciones te ayudan a estar al tanto de nuevos pedidos</li>
                      <li>Puedes configurar múltiples métodos de notificación</li>
                      <li>El email es obligatorio para el funcionamiento del sistema</li>
                      <li>Las notificaciones del navegador requieren permiso del usuario</li>
                    </ul>
                  </div>
                </div>
              </div>
