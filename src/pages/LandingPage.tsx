  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-20 right-10 w-72 h-72 bg-orange-200 rounded-full mix-blend-multiply filter blur-xl opacity-80 animate-blob"></div>
        <div className="absolute top-40 left-10 w-72 h-72 bg-orange-200 rounded-full mix-blend-multiply filter blur-xl opacity-80 animate-blob animation-delay-2000"></div>
