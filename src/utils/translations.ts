...
const translations: Record<Language, Translations> = {
  es: {
    ...
    authPageSubtitle: 'Gestión, pedidos y satisfacción: todo en un solo lugar',
    ...
    billing_settings_subtitle: 'Información legal y fiscal para la generación de tickets de pedido válidos en Colombia',
    ...
    billing_settings_title: 'Configuración de Facturación',
    billing_settings_subtitle: 'Información legal y fiscal para la generación de tickets de pedido válidos en Colombia',
    restaurant_info_billing: 'Información del Restaurante',
    commercial_name_label: 'Nombre Comercial *',
    commercial_name_placeholder: 'Restaurante Orlando',
    social_reason_label: 'Razón Social *',
    social_reason_placeholder: 'Orlando SAS',
    nit_label: 'NIT *',
    nit_placeholder: '900123456-7',
    nit_invalid: 'El NIT no es válido.',
    tax_regime_label: 'Régimen Tributario *',
    iva_responsible_label: 'Responsable de IVA',
    has_dian_resolution: '¿Tiene Resolución DIAN?',
    department_label: 'Departamento *',
    city_label: 'Ciudad *',
    address_billing_label: 'Dirección *',
    address_billing_placeholder: 'Calle 123 #45-67',
    phone_billing_label: 'Teléfono *',
    phone_billing_placeholder: '+57 300 123 4567',
    email_billing_label: 'Correo Electrónico *',
    email_billing_placeholder: 'contacto@restaurante.com',
    dian_resolution_data: 'Datos de la Resolución DIAN',
    resolution_number_label: 'Número de Resolución *',
    resolution_number_placeholder: '18760000001',
    resolution_date_label: 'Fecha de Resolución *',
    numbering_range_label: 'Rango de Numeración *',
    from_label: 'Desde',
    to_label: 'Hasta',
    from_placeholder: '1000',
    to_placeholder: '10000',
    tax_tip_settings: 'Configuración de Impuestos y Propina',
    suggested_tip_label: '¿Aplica Propina Sugerida?',
    ticket_customization: 'Personalización del Ticket',
    show_logo_ticket: '¿Mostrar logo en el ticket?',
    ticket_logo_label: 'Logo para el ticket',
    ticket_message_label: 'Mensaje Final del Ticket',
    ticket_message_placeholder: 'Ej: Gracias por tu compra! Vuelve pronto.',
    notes_about_billing: 'Notas sobre Facturación:',
    billing_legal_tickets: 'Importante para la generación de tickets de pedido legalmente válidos en Colombia',
    billing_iva_calc: 'Si eres responsable de IVA, el IVA se calculará y mostrará en cada ticket',
    billing_dian_fe: 'La resolución DIAN es requerida para facturación electrónica',
    billing_tip_optional: 'La propina es opcional y aparecerá como sugerencia al cliente',
    billing_keep_updated: 'Asegúrate de mantener esta información actualizada',
    select_department: 'Selecciona un Departamento',
    select_city: 'Selecciona una Ciudad',
    select_department_first: 'Selecciona primero el departamento',
    field_required: 'Este campo es obligatorio.',
    promo_settings_title: 'Configuración Promocional',
    promo_settings_subtitle: 'Configura la imagen promocional y los productos destacados en tu menú público',
    vertical_promo_label: 'Imagen Promocional Vertical',
    vertical_promo_hint: 'Sube una imagen que aparecerá al hacer clic en el botón de promociones en el menú público',
    featured_products_title: 'Productos Destacados',
    featured_products_hint: 'Selecciona hasta 5 productos para mostrar en el carrusel de destacados',
    max_5_products: 'Máximo 5 productos seleccionados',
    featured_badge: 'Destacado',
    support_title: 'Soporte Técnico',
    support_subtitle: 'Crea un nuevo ticket de soporte o revisa el estado de los tickets existentes',
    create_new_ticket: 'Crear Nuevo Ticket de Soporte',
    subject_required_label: 'Asunto *',
    subject_placeholder: 'Describe brevemente tu consulta',
    priority_label: 'Prioridad',
    category_label: 'Categoría',
    message_required_label: 'Mensaje *',
    message_placeholder: 'Tu mensaje detallado...',
    message_detailed_placeholder: 'Describe detalladamente tu consulta o problema. Incluye pasos para reproducir el problema si es técnico.',
    contact_email_label: 'Email de Contacto',
    contact_phone_label: 'Teléfono de Contacto',
    send_ticket_button: 'Enviar Ticket',
    ticket_sent_title: 'Ticket Enviado',
    ticket_sent_success: 'Tu solicitud de soporte ha sido enviada con éxito. Te responderemos lo antes posible.',
    my_tickets_title: 'Mis Tickets de Soporte',
    id_header: 'ID',
    subject_header: 'Asunto',
    priority_header: 'Prioridad',
    status_header: 'Estado',
    date_header: 'Fecha',
    actions_header: 'Acciones',
    view_details_button: 'Ver Detalles',
    clear_form_button: 'Limpiar Formulario',
    ticket_detail_title: 'Detalle del Ticket',
    ticket_info_title: 'Información del Ticket',
    ticket_id_label: 'ID del Ticket',
    opened_by_label: 'Abierto por',
    creation_date_label: 'Fecha de Creación',
    ...
    client_message_title: 'Mensaje del Cliente',
    admin_response_title: 'Respuesta del Administrador',
    admin_no_response: 'El administrador aún no ha respondido a este ticket.',
    additional_notes_title: 'Notas Adicionales',
    awaiting_response_title: 'Esperando Respuesta',
    awaiting_response_text: 'Tu ticket está siendo revisado por nuestro equipo. Te contactaremos pronto.',
  ...
  en: {
    ...
    authPageSubtitle: 'Management, orders, and satisfaction: all in one place',
    ...
    restaurant_info_billing_title: 'Restaurant Information',
    ...
    social_media_subtitle: 'Connect your social media to appear on your public menu',
    ...
    billing_settings_title: 'Billing Settings',
    billing_settings_subtitle: 'Legal and tax information for generating valid order tickets in Colombia',
    restaurant_info_billing: 'Restaurant Information',
    commercial_name_label: 'Commercial Name *',
    commercial_name_placeholder: 'Orlando Restaurant',
    social_reason_label: 'Business Name *',
    social_reason_placeholder: 'Orlando LLC',
    nit_label: 'Tax ID *',
    nit_placeholder: '900123456-7',
    nit_invalid: 'The Tax ID is not valid.',
    tax_regime_label: 'Tax Regime *',
    iva_responsible_label: 'VAT Responsible',
    has_dian_resolution: 'Has Tax Authority Resolution?',
    department_label: 'State *',
    city_label: 'City *',
    address_billing_label: 'Address *',
    address_billing_placeholder: '123 Main St',
    phone_billing_label: 'Phone *',
    phone_billing_placeholder: '+57 300 123 4567',
    email_billing_label: 'Email *',
    email_billing_placeholder: 'contact@restaurant.com',
    dian_resolution_data: 'Tax Authority Resolution Data',
    resolution_number_label: 'Resolution Number *',
    resolution_number_placeholder: '18760000001',
    resolution_date_label: 'Resolution Date *',
    numbering_range_label: 'Numbering Range *',
    ...
    from_placeholder: '1000',
    to_placeholder: '10000',
    tax_tip_settings: 'Tax and Tip Settings',
    suggested_tip_label: 'Apply Suggested Tip?',
    ticket_customization: 'Ticket Customization',
    show_logo_ticket: 'Show logo on ticket?',
    ticket_logo_label: 'Ticket logo',
    ticket_message_label: 'Ticket Final Message',
    ticket_message_placeholder: 'E.g.: Thank you for your purchase! See you soon.',
    notes_about_billing: 'Notes about Billing:',
    billing_legal_tickets: 'Important for generating legally valid order tickets in Colombia',
    billing_iva_calc: 'If you are VAT responsible, VAT will be calculated and shown on each ticket',
    billing_dian_fe: 'Tax authority resolution is required for electronic billing',
    billing_tip_optional: 'Tip is optional and will appear as a suggestion to the customer',
    billing_keep_updated: 'Make sure to keep this information updated',
    select_department: 'Select a State',
    select_city: 'Select a City',
    select_department_first: 'Select the state first',
    field_required: 'This field is required.',
    promo_settings_title: 'Promotional Settings',
    promo_settings_subtitle: 'Configure the promotional image and featured products on your public menu',
    vertical_promo_label: 'Vertical Promotional Image',
    vertical_promo_hint: 'Upload an image that will appear when clicking the promotions button on the public menu',
    featured_products_title: 'Featured Products',
    featured_products_hint: 'Select up to 5 products to show in the featured carousel',
    max_5_products: 'Maximum 5 products selected',
    featured_badge: 'Featured',
    support_title: 'Technical Support',
    support_subtitle: 'Create a new support ticket or check the status of existing tickets',
    create_new_ticket: 'Create New Support Ticket',
    subject_required_label: 'Subject *',
    subject_placeholder: 'Briefly describe your query',
    priority_label: 'Priority',
    category_label: 'Category',
    message_required_label: 'Message *',
    message_placeholder: 'Your detailed message...',
    message_detailed_placeholder: 'Describe your query or problem in detail. Include steps to reproduce the problem if technical.',
    contact_email_label: 'Contact Email',
    contact_phone_label: 'Contact Phone',
    send_ticket_button: 'Send Ticket',
    ticket_sent_title: 'Ticket Sent',
    ticket_sent_success: 'Your support request has been sent successfully. We will respond as soon as possible.',
    ...
    creation_date_label: 'Creation Date',
    last_update_label: 'Last Update',
    client_message_title: 'Customer Message',
    admin_response_title: 'Administrator Response',
    admin_no_response: 'The administrator has not yet responded to this ticket.',
    additional_notes_title: 'Additional Notes',
    awaiting_response_title: 'Awaiting Response',
    awaiting_response_text: 'Your ticket is being reviewed by our team. We will contact you soon.',
